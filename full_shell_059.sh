for ii in $(seq 66 132)
do
 trial=$(echo "scale=0; (8602+$ii);" | bc)
 ...
 spring=$(echo "scale=2; (200.);" | bc)
 pexcvol=$spring
 force=$(echo "scale=8; (50.+50.*$modtwelve);" | bc)
 lcontrol=$(echo "scale=0; (0);" | bc)
 pstiffness=$(echo "scale=2; (0.);" | bc)
 pvelocity=$(echo "scale=2; (0.);" | bc)
 radius=$(echo "scale=8; (7.07106781);" | bc)
 seed=$(echo "scale=0; (57+$modeleven);" | bc)
 ...
 boxlength=$(echo "scale=4; (4.1*$radius);" | bc)
